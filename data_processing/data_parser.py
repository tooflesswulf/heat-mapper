...
if __name__ == '__main__':
    ...
    if save:
        ...
        to_disp = img_celsius[frame_num]
    else:
        to_disp = conv_celsius(img[frame_num])
        print('Displaying image number: {}'.format(frame_num))
        print('This frame was taken at t={} after the start of the program.'.format(times[frame_num] - times[0]))
    ...
    if not save:
        plt.figure("Image number {}".format(frame_num))
